 ...
 */
package refactor.com.android.contacts.common.list;
...
public class ViewPagerTabs extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private boolean mTabEanbled = true;
    ...
    /**
     * Set a listener that will be invoked whenever the tab changes or is incrementally
     * scrolled. See {@link OnTabClickListener}.
     *
        ...
        textView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mTabEanbled) {
                    ...
                    int newPostion = getRtlPosition(position);
                    if (oldPosition != newPostion) {
                        mPager.setCurrentItem(getRtlPosition(position));
                    } else {
//                        Toast.makeText(v.getContext(), "Reselect "+oldPosition, Toast.LENGTH_SHORT).show();
                        if (mOnTabClickListener != null) {
                            mOnTabClickListener.onTabReclicked(newPostion);
                        }
                    }
                }
            }
        ...
        mTabStrip.addView(textView, new LinearLayout.LayoutParams(/*LayoutParams.WRAP_CONTENT*/0,

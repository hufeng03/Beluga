...
//        public static int REMOTE = 2;
    ...
    public ActionBarAdapter(Context context, Listener listener, ActionBar actionBar,
                            View portraitTabs, View landscapeTabs, Toolbar toolbar, ActionBarDrawerToggle drawerToggle) {
        mContext = context;
        mListener = listener;
    ...
    public void initialize(Bundle savedState, BelugaRequest request) {
        if (savedState == null) {
...
//                mDrawerToggle.setDrawerIndicatorEnabled(true);
    ...
    private void updateDisplayOptions(boolean isIconifiedChanging) {
        if (mSearchMode) {
            ...
            if (mListener != null) {
                mListener.onAction(Listener.Action.STOP_SEARCH_MODE);

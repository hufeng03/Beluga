 ...
 */
public class UiServiceHelper implements ServiceConnection {

    private static final String LOG_TAG = UiServiceHelper.class.getSimpleName();

    static UiServiceHelper mServiceHelper = null;
    ...
    synchronized public static UiServiceHelper getInstance() {
        if (mServiceHelper == null) {
            mServiceHelper = new UiServiceHelper();
        }

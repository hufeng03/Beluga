 ...
 */
public class DirectoryMonitorImpl {

    private static final boolean DEBUG = BuildConfig.DEBUG;

    private static final String LOG_TAG = DirectoryMonitorImpl.class.getSimpleName();
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 0) {
                ...
                if (!TextUtils.isEmpty(path)) {
                    ...
                    ServiceCallUiHelper.getInstance().changeMonitored(path);
                }
            }
        }
    }

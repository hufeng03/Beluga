...
import com.hufeng.filemanager.R.id;
import com.hufeng.filemanager.R.layout;
...
public class AlertController {
    ...
    private void setupView() {
        ...
        TypedArray a = mContext.obtainStyledAttributes(
                null, R.styleable.AlertDialog, 0, R.style.FMAlertDialogBkgStyle);
...
//                    mIconView.setVisibility(View.GONE);
    ...
    private void centerButton(Button button) {
        ...
        View spacer = mWindow.findViewById(R.id.midSpacer1);
        spacer.setVisibility(View.GONE);
        spacer = mWindow.findViewById(R.id.midSpacer2);
        spacer.setVisibility(View.GONE);
    }
    ...
    private void setBackground(LinearLayout topPanel, LinearLayout contentPanel,
        ...
        int topDark = a.getResourceId(
                R.styleable.AlertDialog_topDark, 0);
        int centerDark = a.getResourceId(
                R.styleable.AlertDialog_centerDark, 0);
        int bottomDark = a.getResourceId(
                R.styleable.AlertDialog_bottomDark, 0);
        int fullBright = a.getResourceId(
                R.styleable.AlertDialog_fullBright, 0);
        int topBright = a.getResourceId(
                R.styleable.AlertDialog_topBright, 0);
        int centerBright = a.getResourceId(
                R.styleable.AlertDialog_centerBright, 0);
        int bottomBright = a.getResourceId(
                R.styleable.AlertDialog_bottomBright, 0);
        int bottomMedium = a.getResourceId(
                R.styleable.AlertDialog_bottomMedium, 0);

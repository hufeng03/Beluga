...
//		}
		...
		toolArray.add(new Tool(R.string.tool_name_ftp, R.string.tool_description_ftp, R.drawable.tool_icn_ftp, context.getPackageName(),"com.hufeng.swiftp.ServerControlActivity"));
		toolArray.add(new Tool(R.string.tool_name_http, R.string.tool_description_http, R.drawable.tool_icn_http, context.getPackageName(),"com.hufeng.nanohttpd.ServerControlActivity"));
    	toolArray.add(new Tool(R.string.tool_name_safe, R.string.tool_description_safe, R.drawable.tool_icn_safe, context.getPackageName(), "com.hufeng.filemanager.SafeBoxActivity"));
		toolArray.add(new Tool(R.string.tool_name_kanbox, R.string.tool_description_kanbox, R.drawable.tool_icn_kanbox, context.getPackageName(), "com.hufeng.filemanager.KanBoxActivity"));
        toolArray.add(new Tool(R.string.tool_name_selected, R.string.tool_description_selected, R.drawable.tool_icn_recommend, context.getPackageName(), "com.hufeng.filemanager.ResourceActivity"));

...
public class Constants {
    ...
    public static final String KANBOX_APK_URL="http://download.kanbox.com/kcn/android/kanbox_24101.apk"; //凡卓
    ...
    public static final String PRODUCT_FLAVOR_NAME = "goinee";
}
